...
const routes: Routes = [
  ...
  {path: 'pago/add', component: AddPaymentComponent, canActivate:[AdminGuard]},
  {path: 'pago/:id', component: PaymentDetailsComponent, canActivate:[AuthGuard]},
  {path: 'admin/pago/crear', component: AddPaymentComponent, canActivate:[AdminGuard]},
